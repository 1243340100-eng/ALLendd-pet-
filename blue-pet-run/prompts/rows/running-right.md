Create one horizontal animation strip for Codex pet `blue`, state `running-right`.
...
Identity: same pet in every frame: round sky-blue octopus mascot with eight small round tentacles, large shiny blue eyes, pink cheek dots, and a soft crooked black wizard hat with a white band; friendly compact sticker-like paper-cut mascot style. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `sticker`: Polished sticker mascot with bold clean shapes, crisp outline, flat colors, and minimal highlight detail. User style notes: Preserve the reference image clean soft paper-cut sticker feel, rounded simple forms, blue palette, black witch hat with a white band, and tiny cute face..
